...
export const ACHIEVEMENTS: Achievement[] = [
    ...
    },
    {
        ...
        name: 'PPPPP',
        description: 'Hundred correct answers!',
        condition: (stats: Stats) => stats.correctAnswers >= 130
    },
    {
        id: 7,
        name: 'Perseverance V',
        description: 'Five hundred correct answers!',
        condition: (stats: Stats) => stats.correctAnswers >= 500
    },
    {
        id: 8,
        name: 'Perseverance VI',
        description: 'Thousand correct answers!',
        condition: (stats: Stats) => stats.correctAnswers >= 1000
    },
    {
        id: 9,
        name: 'First Module Finished',
